		...
		return (
	      ...
	      >
			...
			<SubMenu key="sub4" title={<span>实习报名</span>} className={sxbm ? '' : 'hide'}>
			  ...
			  <Menu.Item key="14" className={this.props.role.job_chose == 1 ? '':'hide'}><Link to='/jobChose'>选择岗位</Link></Menu.Item>
	          <Menu.Item key="15" className={this.props.role.submit_document == 1 ? '':'hide'}><Link to='/notComplete'>提交文档</Link></Menu.Item>	          		 
	        </SubMenu>                              
	      </Menu>
		);
	}
