...
import './ResearchYearList.scss'

const confirm = Modal.confirm;


class GraduateYearList extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			yearData: [], //年度数据
	...
	showDeleteConfirm(id, e) {
		...
		function deleteTeacher(id) {
			fetch(config.api + '/Research/deleteYear?id=' + id, {
				method: 'get',
				mode: 'cors',
				credentials: "include",
				headers: {
	...
	add = () => {
		...
		fetch(config.api + '/Research/addYear', {
			method: 'post',
			mode: 'cors',
			credentials: "include",
			body: bodyquery,
	...
	modify = () => {
		...
		fetch(config.api + '/Research/modifyYear', {
			method: 'post',
			mode: 'cors',
			credentials: "include",
			body: bodyquery,
...
export default GraduateYearList;